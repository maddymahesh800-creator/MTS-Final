...
/**
 * Bean definitions for {@link RewardRepository}.
 */
@Generated
public class RewardRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'rewardRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getRewardRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'rewardRepository'.
   */
  public static BeanDefinition getRewardRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, RewardRepository.class, Rewards.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.fd.repository.RewardRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.RewardRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.fd.repository.RewardRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getRewardRepositoryInstanceSupplier();
